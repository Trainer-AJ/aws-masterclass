# FROM AV
'''
AIM: Delete all unwanted EBS Volumes i.e the ones which are not ATTACHED to any Running instances' EBS volume

1. Check for all Running Ec2
2. list all EBS snapshots
